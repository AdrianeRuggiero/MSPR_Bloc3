...
MODEL_PATH = "models/saved_models/best_model_gradientboost.pkl"
...
# === Entraînement avec variation de learning_rate
best_accuracy = 0
best_model = None
accuracies = []
...
for i, lr in enumerate(learning_rates, 1):
    ...
    print(f"Époque {i}/10 - learning_rate={lr:.2f} - Accuracy : {acc:.4f}")
...
print(f" Modèle Gradient Boosting sauvegardé dans {MODEL_PATH}")

# === Graphe accuracy
plt.figure()
plt.plot(learning_rates, accuracies, marker='o')
plt.title("Évolution de l'Accuracy - Gradient Boosting")
...
# Camembert
counts.plot.pie(autopct='%1.1f%%', figsize=(6, 6), title="Prédiction Rhône - Gradient Boosting")
plt.ylabel("")
plt.tight_layout()
plt.show()
